...
function groupMetricsByFunnel(metrics: SDRMetric[]): FunnelData[] {
  ...
  return Array.from(funnelMap.values()).sort((a, b) => b.sales - a.sales || b.activated - a.activated);
}
...
export function SDRFunnelComparisonChart({ metrics }: SDRFunnelComparisonChartProps) {
    ...
    <div className="bg-card rounded-2xl border border-border/40 overflow-hidden">
      <div className="px-5 pt-5 pb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-foreground">Comparativo por Funil</h3>
        </div>
      </div>
